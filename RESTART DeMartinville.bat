@echo off
title DeMartinville - restart
echo.
echo    Restarting DeMartinville with the latest version...
echo    (stopping the old server, then starting fresh)
echo.
rem Stop the DeMartinville server on port 7777 — the listening process AND its parent
